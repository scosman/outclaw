		...
		{:else if wizardStore.currentStep === 'channel'}
			...
			<div class="mx-auto w-full max-w-2xl px-6 py-8">
				...
				<div class="space-y-4">
					...
					<button
						type="button"
						class="group flex w-full cursor-pointer items-start gap-4 rounded-lg border-2 border-zinc-700 p-4 text-left transition-all hover:border-zinc-600 hover:bg-zinc-800/50"
						onclick={() => (showTelegramDialog = true)}
					>
						<div
							class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-zinc-800 text-zinc-400"
						>
